                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-semibold text-gray-900 mt-1">$12,500</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-semibold text-gray-900 mt-1">$450</p>
                    </div>
                  ...
                  <div className="mt-4 flex items-center text-sm">
                    <span className="text-yellow-500 font-medium">Due in 5 days</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="divide-y divide-gray-200">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="grid grid-cols-4 gap-4 p-4 text-sm">
                      ...
                      <div className="text-gray-500">123 Main St, City, State</div>
